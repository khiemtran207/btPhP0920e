<?php
    ...
    // lấy dữ liệu từ csdl
    // viết câu truy vấn
$sql_select = "SELECT * FROM staff ORDER BY id DESC ";
// thực hiện truy vấn
$is_select = mysqli_query($connection, $sql_select);
// chuyển về mảng một chiều
$is_select = mysqli_fetch_all($is_select, MYSQLI_ASSOC);
//echo "<pre>";
//print_r($is_select);
//echo "</pre>";
?>
...
<!--                    <td>--><?php //echo $item['birthday'] ;?><!--</td>-->
                    <td><?php
                        if($item['birthday'] == "0000-00-00 00:00:00"){
                            echo "";
                        }else{
